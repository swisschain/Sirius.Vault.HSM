...
public class LocalForge {
    public List<OperationContent> UnforgeOperations(byte[] bytes) throws IOException, NoSuchAlgorithmException, InvalidInputsException {
    ...
    private static OperationContent UnforgeOperation(ForgedReader reader) throws IOException, InvalidInputsException, NoSuchAlgorithmException {
    ...
    static TransactionContent UnforgeTransaction(ForgedReader reader) throws InvalidInputsException, IOException, NoSuchAlgorithmException {
    ...
    static String UnforgeEntrypoint(ForgedReader reader) throws IOException, InvalidInputsException {
        ...
        switch (ep)
        {
            ...
            case -1: return reader.ReadString(1);
            default: throw new InvalidInputsException("Unrecognized endpoint type " + ep);
        }
    }

    static TransactionContent.Parameters UnforgeParameters(ForgedReader reader) throws IOException, InvalidInputsException {
        if(reader.ReadBool()){
    ...
    static RevealContent UnforgeReveal(ForgedReader reader) throws InvalidInputsException, IOException, NoSuchAlgorithmException {
