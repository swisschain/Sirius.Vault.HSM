...
public class ForgedReader {
  ...
  public int ReadInt32(int len) throws IOException {
    if (len < 1 || 4 < len) throw new IllegalArgumentException("len must be between 1 and 4");
  ...
  public String ReadPublicKey()
    ...
    switch (id) {
      ...
      case 2:
        ...
        break;
      default:
        throw new InvalidInputsException("Invalid public key prefix id");
    }
  ...
  public String ReadAddress() throws IOException, InvalidInputsException, NoSuchAlgorithmException {
    ...
    switch (type) {
      case 0:
        return ReadTzAddress();
      case 1:
        return ReadKtAddress();
      default:
        throw new InvalidInputsException("Invalid address prefix type");
    }
  }
  ...
  public <T> T ReadEnumerableSingle(Function<ForgedReader, T> readData)
