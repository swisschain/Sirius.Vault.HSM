...
import io.swisschain.crypto.transaction.signing.validators.TezosTransactionValidator;
...
public class HsmTezosTransactionSigner extends HsmConnector implements CoinsTransactionSigner {
  ...
  public TransactionSigningResult sign(
      ...
      TransferDetails transferDetails) throws IOException, NoSuchAlgorithmException, InvalidInputsException, TransferDetailsValidationException {
        TezosTransactionValidator.validate(transferDetails, unsignedTransaction, publicKey);
