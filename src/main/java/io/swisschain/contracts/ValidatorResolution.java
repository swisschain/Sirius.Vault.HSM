...
public class ValidatorResolution {
  ...
  /**
   * Gets the original document signed be validator. This document presented in JSON format. See
   * structure ValidatorResponse.
   */
  ...
  /**
   * Sets the original document signed be validator. This document presented in JSON format. See
   * structure ValidatorDocument.
   */
