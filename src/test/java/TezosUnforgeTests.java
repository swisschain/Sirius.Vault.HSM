...
public class TezosUnforgeTests {
  @Test
  public void should_unforge_transfer()
      throws IOException, NoSuchAlgorithmException, InvalidInputsException {
    var source =
        "5m82GxuCxgGzzgQDBE5NLfvGhZ5w2WHJkASqJoPp21yw797a4qBUkjL7HepNcZ5ARrkzweAvsEmS92SC93BqVzQSTRGNTXe3dy55XCA13UbntiyFDfejppX";
  ...
  @Test
  public void should_unforge_reveal()
      throws IOException, NoSuchAlgorithmException, InvalidInputsException {
    var source =
        "MkKmShezRW2dkNu8z1U6nS2oya3HiFs5Sm9YRFsr8LMqSYWAdg55VD1XbnE7JYg2YJnjWqi1dphj82zt5LUfzZ4V1LkVcUjz3h9LGoJdt1qbXE1z8mYC9AaXm9VVnAuevbKeGkpraL7oBKFAJFAR4y1F1XAwqRT1pmGFg4saqYAuinESy9nmKr99WpM444e1i1r9KmoFkUiqu";
    var bytes = Base58Helper.decode(source);
    ...
    Assert.assertEquals(
        "edpkvWbPgoa5yGDVDC4Hpy7sde5WpjUpMULpsUq6MKRaCSB9fJzZT8", revealContent.PublicKey);
  ...
  @Test
  public void should_unforge_smart_contract()
      throws IOException, NoSuchAlgorithmException, InvalidInputsException {
    var source =
        "";
    var bytes = Base58Helper.decode(source);
